...
export const siteConfig = {
  ...
  testimonials: [
    ...
    },
    {
      ...
      text: "A hidden gem in Plaka! The atmosphere is authentic and charming, not touristy at all. We had the traditional mezze platter and homemade moussaka - both were delicious. Perfect spot for a lazy afternoon with Greek coffee and dessert.",
    ...
    },
    {
      ...
      rating: 5,
      time: "πριν 10 ημέρες",
      text: "Ένα κομμάτι της πραγματικής Πλάκας που δεν έχει χάσει την αυθεντικότητά του. Τιμές λογικές, φαγητό νόστιμο. Το μουσακάς και το σαγανάκι ήταν από τα καλύτερα που έχω φάει!",
      platform: "google" as const,
    },
    {
      name: "Κατερίνα Μ.",
  ...
  gallery: [
    ...
    { id: 6, alt: "Φρέσκος μουσακάς με χρυσαφένια μπεσαμέλ και παραδοσιακή χωριάτικη σαλάτα" },
  ],
